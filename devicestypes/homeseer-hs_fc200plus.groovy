...
metadata {
  ...
  preferences {
    ...
    input("speedType", "enum", title: "How many speed fan?", options: ["3 Speed", "4 Speed"], description: "Select a fan speed", required: true, default: "3 Speed")
...
def setStatusLed(led, color, blink) {
  ...
  if (blink) {
    ...
    switch (led) {
      case 1:
        blinkval = blinkval & 0xE
        break
      case 2:
        blinkval = blinkval & 0xD
        break
      case 3:
        blinkval = blinkval & 0xB
        break
      case 4:
