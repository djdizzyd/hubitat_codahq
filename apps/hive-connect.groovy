  ...
  if (username == null || username == '' || password == null || password == '') {
    ...
    return dynamicPage(name: "mainPage", title: "", install: true, uninstall: true) {
      ...
      if (stateTokenPresent()) {
        ...
        section {
          paragraph "There was a problem connecting to Hive. Check your user credentials and error logs in Hubitat.\n\n${state.loginerrors}"
        }
      }
    }
  }
...
def loginPAGE() {
  if (username == null || username == '' || password == null || password == '') {
    return dynamicPage(name: "loginPAGE", title: "Login", uninstall: false, install: false) {
      ...
      section { paragraph "Enter your Hive credentials below to enable Hubitat and Hive integration." }
    ...
    dynamicPage(name: "loginPAGE", title: "Login", uninstall: false, install: false) {
      ...
      if (stateTokenPresent()) {
        ...
        section {
          paragraph "There was a problem connecting to Hive. Check your user credentials and logs in Hubitat.\n\n${state.loginerrors}"
        }
      }
    }
  }
...
def tmaConfigurePAGE() {
  dynamicPage(name: "tmaConfigurePAGE", title: "Hive Mode Automation", install: true, uninstall: true) {
    ...
    if (modeTrigger == "true") {
      ...
      section {
        input ("modes", "mode", title:"When Hubitat enters these modes", multiple: true, required: true)
      }
...
private changeAllThermostatsModes(thermostats, newThermostatMode, reason) {
  ...
  for (thermostat in thermostats) {
    def message = ''
    message = "Hubitat has reset $thermostat.label to $thermostatModeDetail because $reason."
    log.info message
    send(message)
